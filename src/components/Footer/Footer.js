            ...
            <div className="content-body">
                <div className="grid grid-cols-12 gap-[30px]">
                    ...
                    <div className="col-span-12 sm:col-span-6 lg:col-span-3">
                        ...
                        <ul>
                            <li><a className='text-[#E1E2E6] text-lg leading-[32px]' href={'google.com'}>World Bank</a></li>
                            <li><a className='text-[#E1E2E6] text-lg leading-[32px]' href={'google.com'}>ADB</a></li>
                            <li><a className='text-[#E1E2E6] text-lg leading-[32px]' href={'google.com'}>JICA</a></li>
                        </ul>
                    </div>
                    <div className="col-span-12 sm:col-span-6 lg:col-span-5">
                        ...
                        <a className='text-[#E1E2E6] text-lg leading-[32px]' href={'tel:+889551261'}>Tel: 9551261,</a>
                        <a className='text-[#E1E2E6] text-lg leading-[32px]' href={'tel:+889555962'}> 9555962,</a>
                        <a className='text-[#E1E2E6] text-lg leading-[32px]' href={'tel:+889566099'}> 9566099,</a>
                        <a className='text-[#E1E2E6] text-lg leading-[32px]' href={'tel:+889572097'}> 9572097,</a>
                        <a className='text-[#E1E2E6] text-lg leading-[32px]' href={'tel:+889554664'}> 9554664</a>
                        </div>
                    </div>
                    <div className="col-span-12 sm:col-span-6 lg:col-span-2">
