    ...
    return (
        <div className='py-[60px] lg:py-[120px]'>
            <div className="content-body">
                <div className="news-title px-[110px]">
                    <div className="meta flex gap-5 items-center">
                        <p className='uppercase font-semibold text-[#555555]'>Our Blog</p>
                        <span className='w-[5px] h-[5px] bg-[#D9D9D9] rounded-full'></span>
                        <p className='uppercase font-semibold text-[#555555]'>December 20, 2023</p>
                    </div>
                    <h3 className='text-[#000225] font-semibold text-4xl leading-[44px] mt-[26px]' >Bangladesh Petroleum Corporation was established by Ordinance No. of 1976.</h3>
                </div>
                <div className="thumbnail-img my-[60px] text-center">
                    <img className='max-w-full' src={thumbImg} alt="" />
                </div>
                <div className="grid grid-cols-12 gap-[60px]">
                    <div className="news-body col-span-8">
                    ...
                    <div className="side-bar col-span-4">
