                    ...
                    <div className="grid grid-cols-12 gap-[30px] lg:gap-[60px]">
                        <div className="card-group col-span-12 md:col-span-8">
                            <div className="grid grid-cols-12 gap-[30px]">
                                <div className="card-item rounded-[10px] border-solid border-[1px] border-[#F7F7F7] overflow-hidden col-span-12 sm:col-span-6">
                                    ...
                                    <div className="info p-[30px]">
                                        <h3 className='text-[#000225] text-2xl font-semibold'>E-Documents Online</h3>
